...
<head>
    ...
    <title>@yield('title', 'Siswa Dashboard') | SIAKAD SMK Muhammadiyah 2</title>
                        ...
                        <div class="relative">
                            <button @click="profileOpen = !profileOpen" @click.away="profileOpen = false" class="flex items-center space-x-3 focus:outline-none hover:bg-gray-50 p-1.5 rounded-xl transition-colors">
                                <div class="hidden md:block text-right">
                                    <p class="text-sm font-bold text-blue-900 leading-tight">{{ auth()->user()->name ?? 'Siswa' }}</p>
                                    <p class="text-[11px] font-medium text-gray-500">Siswa</p>
                                </div>
                                <div class="w-9 h-9 rounded-full bg-blue-50 border-2 border-white shadow-sm flex items-center justify-center overflow-hidden shrink-0">
                                    <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name ?? 'Siswa') }}&background=EFF6FF&color=1D4ED8&bold=true" alt="Profile" class="w-full h-full object-cover">
                                </div>
                            </button>
                            ...
                            <div x-show="profileOpen" 
                                ...
                                <a href="{{ route('siswa.profile.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors">
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    @if ($errors->any())
                        <div class="bg-red-50 border-l-4 border-red-500 text-red-700 p-4 rounded-md shadow-sm mb-6 flex items-start animate-fade-in-down">
                            ...
                            <div>
                                <h3 class="text-sm font-medium">Perhatikan Form Anda</h3>
