...
<head>
    ...
    <title>@yield('title', 'Guru') | SIAKAD SMK Muhammadiyah 2</title>
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="flex items-center space-x-3 border-l pl-6 border-gray-200">
                            <div class="text-right">
                                <p class="text-sm font-semibold text-blue-900">{{ auth()->user()->name ?? 'Ahmad Tohari S.Kom' }}</p>
                            ...
                            <div class="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center overflow-hidden border border-gray-200">
                                <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name ?? 'Guru') }}&background=0D8ABC&color=fff" alt="Profile" class="w-full h-full object-cover">
                            </div>
                        </div>
                    </div>
                </div>
