...
<div class="mb-6 md:mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    ...
    <div class="flex-shrink-0">
        <a href="{{ route('siswa.absensi.index') }}" class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2.5 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 text-sm font-semibold rounded-xl transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white">
        ...
        <form method="GET" action="{{ route('siswa.absensi.rekap') }}" class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            <div class="relative">
                ...
                <tr class="hover:bg-blue-50/50 transition-colors group">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-gray-500">
                        <div class="flex items-center">
                            ...
                            {{ $absensi->waktu_presensi?->translatedFormat('H:i') ?? '—' }}
                        </div>
                    </td>
