...
@section('content')
<div class="max-w-3xl">
    <a href="{{ route('guru.pengumuman.index') }}" class="inline-flex items-center text-sm font-medium text-blue-700 hover:text-blue-900 mb-4">
    ...
    <article class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-blue-800 to-blue-900 px-6 py-8 text-white">
            <span @class([
                ...
                'bg-green-400/30' => $pengumuman->target === 'guru',
            ])>
                {{ $pengumuman->target === 'semua' ? 'Untuk Semua' : 'Untuk Guru' }}
            </span>
