        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-3">
                <div class="flex justify-between border-b pb-2">
                    ...
                    <span class="font-medium">{{ $kelas->kode_kelas }}</span>
                </div>
                <div class="flex justify-between border-b pb-2">
                ...
                <div class="flex justify-between border-b pb-2">
                    ...
                    <span class="font-medium">Kelas {{ $kelas->tingkat }}</span>
                </div>
                <div class="flex justify-between border-b pb-2">
                    <span class="text-gray-500">Jurusan</span>
                    <span class="font-medium">{{ $kelas->jurusan->nama_jurusan }}</span>
                </div>
                <div class="flex justify-between border-b pb-2">
                    <span class="text-gray-500">Wali Kelas</span>
                    <span class="font-medium">{{ $kelas->waliKelas?->nama_lengkap ?? 'Belum ditentukan' }}</span>
                </div>
                <div class="flex justify-between border-b pb-2">
                    <span class="text-gray-500">Tahun Ajaran</span>
                    <span class="font-medium">{{ $kelas->tahunAjaran->tahun }} - Semester {{ $kelas->tahunAjaran->semester }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-500">Jumlah Siswa</span>
                    <span class="font-bold text-blue-600">{{ $kelas->siswas->count() }} orang</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="lg:col-span-2">
        <div class="bg-white rounded-lg shadow">
            <div class="p-6 border-b flex justify-between items-center">
                ...
                <a href="{{ route('admin.siswa.index', ['kelas_id' => $kelas->id]) }}" class="text-blue-600 hover:underline text-sm">
            ...
            <div class="p-6">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 font-mono">{{ $siswa->nis }}</td>
                ...
                @else
                <p class="text-center text-gray-500 py-8">Belum ada siswa di kelas ini</p>
                @endif
            </div>
        </div>
            ...
            <div class="p-6">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y">
                            @foreach($kelas->jadwals->sortBy(['hari', 'jam_mulai']) as $jadwal)
                            <tr class="hover:bg-gray-50">
                ...
                @else
                <p class="text-center text-gray-500 py-8">Belum ada jadwal pelajaran</p>
                @endif
            </div>
        </div>
    </div>
